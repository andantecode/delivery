...
public class StoreUserBusiness {
    ...
    public StoreUserResponse register(StoreUserRegisterRequest registerRequest) {
        var storeEntity = storeRepository.findFirstByNameAndStatusOrderByIdDesc(registerRequest.getStoreName(), StoreStatus.REGISTERED);

        var entity = storeUserConverter.toEntity(registerRequest, storeEntity.get());
